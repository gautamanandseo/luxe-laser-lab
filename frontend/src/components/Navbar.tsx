...
const serviceCategories = [
  {
    label: "Laser & Light",
    items: [
      { name: "Laser Hair Removal", path: "/laser-hair-removal-delhi" },
      { name: "Tattoo Removal", path: "/tattoo-removal-delhi" },
      { name: "ResurFX™ Resurfacing", path: "/resurfx-delhi" },
    ],
  },
  {
    label: "Face & Skin",
    items: [
      { name: "Skin Treatments", path: "/skin-clinic-delhi" },
      { name: "Acne & Acne Scar", path: "/acne-treatment-delhi" },
      { name: "Skin Lightening", path: "/skin-lightening-delhi" },
      { name: "Anti-Ageing", path: "/anti-ageing-delhi" },
      { name: "HIFU Face Lift", path: "/hifu-treatment-delhi" },
      { name: "Dark Circles", path: "/dark-circles-treatment-delhi" },
      { name: "Skin Tightening", path: "/skin-tightening-delhi" },
      { name: "Microdermabrasion", path: "/microdermabrasion-delhi" },
    ],
  },
  {
    label: "Body",
    items: [
      { name: "CoolSculpting®", path: "/coolsculpting-delhi" },
      { name: "Weight Loss Delhi", path: "/weight-loss-clinic-delhi" },
      { name: "Body Contouring", path: "/body-contouring-delhi" },
      { name: "Stretch Marks", path: "/stretch-marks-delhi" },
      { name: "Mole & Wart Removal", path: "/mole-wart-removal-delhi" },
    ],
  },
  {
    label: "Hair & Injectables",
    items: [
      { name: "Hair Loss & PRP", path: "/hair-loss-treatment-delhi" },
      { name: "Hair Transplant", path: "/hair-transplant-delhi" },
      { name: "Botox & Fillers", path: "/botox-fillers-delhi" },
    ],
  },
  {
    label: "Luxury Experiences",
    items: [
      { name: "Bridal Packages", path: "/bridal-packages-delhi" },
      { name: "Facials & HydraFacial", path: "/facials-delhi" },
      { name: "Salon Services", path: "/salon-services-delhi" },
    ],
  },
];
