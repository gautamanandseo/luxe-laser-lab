...
const seoBlocks = [
  {
    ...
    links: [
      { text: "Laser Hair Removal in Delhi", to: "/laser-hair-removal-delhi" },
  ...
  },
  {
    ...
    links: [
      { text: "CoolSculpting in Delhi", to: "/coolsculpting-delhi" },
      { text: "Weight Loss Clinic Delhi", to: "/weight-loss-clinic-delhi" },
      { text: "Body Contouring Delhi", to: "/body-contouring-delhi" },
    ],
  },
  {
    ...
    links: [
      { text: "Skin Treatments Delhi", to: "/skin-clinic-delhi" },
      { text: "Acne Treatment Delhi", to: "/acne-treatment-delhi" },
      { text: "Skin Lightening Delhi", to: "/skin-lightening-delhi" },
      { text: "Dark Circles Treatment", to: "/dark-circles-treatment-delhi" },
    ],
  },
  {
    ...
    links: [
      { text: "Botox & Fillers Delhi", to: "/botox-fillers-delhi" },
      { text: "HIFU Face Lift Delhi", to: "/hifu-treatment-delhi" },
      { text: "Anti-Ageing Delhi", to: "/anti-ageing-delhi" },
      { text: "Skin Tightening Delhi", to: "/skin-tightening-delhi" },
    ],
  },
  {
    ...
    links: [
      { text: "Hair Loss Treatment Delhi", to: "/hair-loss-treatment-delhi" },
      { text: "Hair Transplant Delhi", to: "/hair-transplant-delhi" },
    ],
  },
  {
    ...
    links: [
      { text: "Bridal Packages Delhi", to: "/bridal-packages-delhi" },
      { text: "Facials & HydraFacial", to: "/facials-delhi" },
    ],
  },
];
