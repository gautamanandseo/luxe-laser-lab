...
const BlogPage = () => {
  ...
  return (
    <div className="pt-20">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <h1 className="font-serif text-5xl md:text-7xl text-foreground mb-4">
              The Empathy <em className="text-primary">Blog</em>
            </h1>
          ...
          <Link to={`/blog/${featuredPost.slug}`} className="group">
            ...
            >
              ...
              <div className="p-8 lg:p-12 flex flex-col justify-center">
                ...
                <h2 className="font-serif text-3xl md:text-4xl text-foreground mb-4 group-hover:text-primary transition-colors">
                  {featuredPost.title}
                </h2>
      ...
      {/* Category Filters */}
      <section className="py-4 bg-background border-b border-border sticky top-16 z-30 backdrop-blur-xl bg-background/80">
        <div className="container mx-auto px-6">
        ...
        <div className="container mx-auto px-6 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <h2 className="font-serif text-4xl md:text-5xl text-foreground mb-4">
              Get Expert <em className="text-primary">Insights</em> Delivered
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
              <input
                ...
                className="flex-1 px-5 py-3 bg-card border border-border rounded-full text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50"
              />
              <button className="gold-shimmer text-primary-foreground px-6 py-3 rounded-full text-sm font-sans uppercase tracking-wider hover:scale-105 transition-transform">
                Subscribe
              </button>
            </div>
          </motion.div>
