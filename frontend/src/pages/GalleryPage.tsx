...
const galleryItems: GalleryItem[] = [
  { src: baAcne, alt: "Acne treatment results", label: "Acne & Scar Treatment", category: ["face"], sessions: "6 sessions", treatmentLink: "/acne-treatment" },
  { src: baBotox, alt: "Botox results - forehead", label: "Botox — Forehead Lines", category: ["face", "injectables"], sessions: "1 session", treatmentLink: "/botox-fillers" },
  { src: baBotox2, alt: "Botox results - crow's feet", label: "Botox — Crow's Feet", category: ["face", "injectables"], sessions: "1 session", treatmentLink: "/botox-fillers" },
  { src: baCoolsculpting, alt: "CoolSculpting abdomen results", label: "CoolSculpting® — Abdomen", category: ["body"], sessions: "2 cycles", treatmentLink: "/coolsculpting" },
  { src: baCoolsculptingChin, alt: "CoolSculpting double chin results", label: "CoolSculpting® — Double Chin", category: ["body"], sessions: "1 cycle", treatmentLink: "/coolsculpting" },
  { src: baFacial, alt: "HydraFacial glow results", label: "HydraFacial Glow", category: ["face"], sessions: "3 sessions", treatmentLink: "/facials" },
  { src: baHifu, alt: "HIFU face lift results", label: "HIFU Non-Surgical Lift", category: ["face"], sessions: "1 session", treatmentLink: "/hifu-treatment" },
  { src: baLaserMen, alt: "Laser hair removal men beard line", label: "Laser — Men's Beard Line", category: ["laser"], sessions: "4 sessions", treatmentLink: "/laser-hair-removal" },
  { src: baLaserUnderarm, alt: "Laser hair removal underarm", label: "Laser — Underarm", category: ["laser"], sessions: "5 sessions", treatmentLink: "/laser-hair-removal" },
  { src: baSkin, alt: "Skin rejuvenation results", label: "Skin Rejuvenation", category: ["face"], sessions: "4 sessions", treatmentLink: "/skin-treatments" },
  { src: baResurfx, alt: "ResurFX skin resurfacing", label: "ResurFX™ — Acne Scars", category: ["face", "laser"], sessions: "3 sessions", treatmentLink: "/resurfx" },
  { src: baResurfx2, alt: "ResurFX pigmentation treatment", label: "ResurFX™ — Pigmentation", category: ["face", "laser"], sessions: "4 sessions", treatmentLink: "/resurfx" },
  { src: baDarkcircles, alt: "Dark circles treatment results", label: "Dark Circles Treatment", category: ["face"], sessions: "6 sessions", treatmentLink: "/dark-circles" },
  { src: baHairloss, alt: "PRP hair loss treatment results", label: "PRP Hair Restoration", category: ["hair"], sessions: "8 sessions", treatmentLink: "/hair-loss-treatment" },
  { src: baHairtransplant, alt: "Hair transplant results", label: "Hair Transplant — FUE", category: ["hair"], sessions: "1 procedure", treatmentLink: "/hair-transplant" },
  { src: baMicroderm, alt: "Microdermabrasion results", label: "Microdermabrasion", category: ["face"], sessions: "5 sessions", treatmentLink: "/microdermabrasion" },
  { src: baMolewart, alt: "Mole removal results", label: "Mole & Wart Removal", category: ["face"], sessions: "1 session", treatmentLink: "/mole-wart-removal" },
  { src: baSkinlightening, alt: "Skin lightening treatment results", label: "Skin Lightening", category: ["face"], sessions: "8 sessions", treatmentLink: "/skin-lightening" },
  { src: baSkintightening, alt: "Skin tightening treatment results", label: "RF Skin Tightening", category: ["face", "body"], sessions: "4 sessions", treatmentLink: "/skin-tightening" },
  { src: baTattoo, alt: "Tattoo removal results", label: "Laser Tattoo Removal", category: ["laser"], sessions: "6 sessions", treatmentLink: "/tattoo-removal" },
  { src: baAntiaging, alt: "Anti-ageing facial results", label: "Anti-Ageing Facial", category: ["face", "injectables"], sessions: "3 sessions", treatmentLink: "/anti-ageing" },
  { src: baBodycontouring, alt: "Body contouring results", label: "Body Contouring", category: ["body"], sessions: "3 sessions", treatmentLink: "/body-contouring" },
];
